...
const SEED = {
  ownerUsername: "thai003_owner",
  ownerName: "THAI003 Owner",
  ownerPasswordHash: "thai003-dev-password-hash",
  staffTelegramUserId: BigInt(91003001),
  staffTelegramChatId: BigInt(91003001),
  staffName: "THAI003 Service Staff",
  categoryName: "THAI003 Drinks",
  itemName: "THAI003 Test Latte",
  itemPrice: BigInt(55000),
  itemQuantity: 2,
  orderCode: "THAI003-SEPAY-001",
  paymentCode: "PAY-THAI003-SEPAY-001",
};

export async function seedThai003SepayWebhook(prisma: PrismaClient) {
  ...
  const menuItem = existingItem
    ? await prisma.menuItem.update({
        ...
        data: {
          description: "Seed item for THAI-003 SePay webhook flow",
  ...
  const order = await prisma.order.upsert({
    ...
    update: {
      ...
      totalAmount,
      customerNote: "THAI003 SePay webhook test order",
  ...
  console.log("Seeded THAI-003 SePay webhook data");
  console.log({
    ownerId: owner.id,
    ...
    paymentCode: SEED.paymentCode,
    sampleSepayTransactionId: "93003001",
